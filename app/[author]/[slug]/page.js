      ...
      <div className="px-8">
        <div className="max-w-[800px] py-24 mx-auto flex flex-col gap-8">
          <div className="flex flex-col gap-5">
            <div className="font-semibold text-4xl text-[#181a2a]">
              {article.title}
            </div>
            <div className="flex gap-6">
              <Link
                ...
                target="_blank"
              >
                <div className="flex gap-2 font-medium text-sm text-[#696a75] items-center cursor-pointer">
                  <Image
              ...
              <div className="font-normal text-sm text-[#696a75] content-center">
                {dayjs(article.published_at)
                  .locale("mn")
                  .format("MMMM D, YYYY")}
              </div>
            </div>
