  ...
  return (
    <div>
      <div className="md:hidden">
        <div className="border border-[#f7f7f7] w-[240px] mx-auto"></div>
        <div className="h-[289px] p-[30px_0px] flex flex-col items-center gap-[30px]">
          <div className="h-[88px] flex justify-center">
            <div className="flex flex-col gap-2">
              <Link target="_self" href="/">
                <Footeritem fItem="Home" />
              </Link>
              <Link href={"/blog"}>
                <Footeritem fItem="Blog" />
              </Link>
              <Link href={"/contact"}>
                <Footeritem fItem="Contact" />
              </Link>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between gap-5 h-24">
            <div className="flex gap-2.5 items-center">
              ...
              <div>
                <div className="font-normal text-xl text-[#141624]">
