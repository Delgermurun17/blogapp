        ...
        <div className="p-[8px_0px] w-[392px] gap-5 flex flex-col md:items-start items-center">
          ...
          <div className="">
            <Link target="_self" href="/">
              <button className="w-[130px] h-10 rounded-md p-[10px_16px] bg-[#4B6BFB] font-medium text-sm text-center text-white active:scale-95 duration-300 hover:bg-[#3f5ee7]">
                Back To Home
              </button>
            </Link>
          </div>
